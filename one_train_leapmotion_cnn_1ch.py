...
def main(testCount,label_list,result_path,subject_name,train_sign_path):
    ...
    stop_trigger = triggers.EarlyStoppingTrigger(monitor='validation/main/loss',max_trigger=(args.epoch, 'epoch'), patients=6)
    ...
    # Run the training
    trainer.run()
    #chainer.serializers.load_npz(f'{result_path}/best.npz', trainer)
    # -----ここまで学習-----
    elapsed_time = time.time() - start
...
if __name__ == '__main__':
    ...
    result_path = "victimresult"
    pickle_path = "victimpickle"
    test_type = "victim"
